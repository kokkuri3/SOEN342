...
public class UserInterface {
        public UserInterface() {
                ...
                String[] columnNames = { "Instructor", "LessonType", "Capacity", "Location", "Start Time", "End Time",
                                "Date" };
                Object[][] data = {
                                // read from Sprint 4\\Lessons.txt for data

                                { "John Doe", "Yoga", "10", "EV-Room A", "12PM", "3PM", "Sundays",
                                                "September 1st to November 30th" },
                                { "Jane Smith", "Yoga", "20", "MB-Room 2", "6PM", "8PM", "Mondays",
                                                "January 5th to March 30th" },
                                { "Alice Johnson", "Dance", "1", "LB-Room 1", "5PM", "7PM", "Wednesdays",
                                                "February 1st to April 30th" },
                                { "Bob Brown", "Swimming", "12", "EV-Pool", "4PM", "6PM", "Fridays",
